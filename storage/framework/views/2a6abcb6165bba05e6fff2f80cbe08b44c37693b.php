        ...
        <div class="col-md-12 ">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="<?php echo e(url('admin/eventos/update')); ?>">
                        ...
                        <div class="form-group<?php echo e($errors->has('id') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="id" type="hidden" class="form-control" name="id" value="<?php echo e($evento->id); ?>"  autofocus>
                            </div>
                        </div>
                        ...
                        <div class="form-group<?php echo e($errors->has('cargaHoraria') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-2">
                                <input id="cargaHoraria" type="number" value="<?php echo e($evento->cargaHoraria); ?>" class="form-control" name="cargaHoraria" > 
                        ...
                        <div class="form-group<?php echo e($errors->has('data_evento') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-3">
                                <input id="data_evento" type="date" class="form-control" name="data_evento" value="<?php echo e($evento->data_evento); ?>" >
