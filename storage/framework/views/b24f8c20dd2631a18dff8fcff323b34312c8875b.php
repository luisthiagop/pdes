                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="<?php echo e(url('/register')); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="password-confirm" type="password" class="form-control" name="password_confirmation" value="<?php echo e(old('password')); ?>" >
                            </div>
                        </div>
                        ...
                        <div class="form-group<?php echo e($errors->has('fone') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="fone" type="tel" class="form-control" name="fone" value="<?php echo e(old('fone')); ?>" >
