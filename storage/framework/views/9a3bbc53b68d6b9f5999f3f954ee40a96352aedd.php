                    ...
                    <?php if(count($eventos)!==0): ?>
                        <div class="panel panel-default" style="margin-top:20px;">
                            ...
                            <?php $__currentLoopData = $eventos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $evento): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                ...
                                <tr>
                                    <td><a href="<?php echo e(url('/evento/'.$evento->id)); ?>"><?php echo e($evento->nome); ?></a></td>
                                    ...
                                    <td><a href="<?php echo e(url('admin/eventos/delete/'.$evento->id)); ?>"><span class="glyphicon glyphicon-minus" aria-hidden="true"></a></span></td>
                                </tr>
